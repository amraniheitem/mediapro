...
class Contactez extends StatefulWidget {
  final String animateurVIPId;

  const Contactez({super.key, required this.animateurVIPId});

  @override
  _ContactezState createState() => _ContactezState();
}

class _ContactezState extends State<Contactez> {
  ...
  Future<void> _submitOrder() async {
    ...
    try {
      final jsonBody = {
        ...
        "type": "ANIMATEURVIP",
        "details": {
          "animateurVIPId": widget.animateurVIPId, // Clé finale confirmée
        ...
        "adresse": _adresseController.text, // Clé en français
        "ville": _villeController.text, // Clé en français
        "nom": _nomController.text, // Ajout des champs manquants
